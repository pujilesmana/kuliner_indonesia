        ...
        <div class="blog-posts text-boxes">
          <div class="isotope row">
            ...
            <div class="col-sm-6 col-md-4 grid-view-post">
              <div class="post">
                <figure class="main"><a href="<?php echo base_url().'Resep/'.$blog_slug;?>"><img src="<?php echo base_url().'assets/images/'.$blog_image;?>" alt="" /></a></figure>
                <div class="box text-center">
                  <!-- <div class="category cat9"><span><a href="#">Urban</a></span></div> -->
                  <h4 class="post-title"><a href="<?php echo base_url().'Resep/'.$blog_slug;?>"><?php echo $blog_judul;?></a></h4>
