              ...
              <div class="box text-center">
                ...
                <div class="gallery-wrapper">
                    <div class="basic-slider">
                      ...
                      <div class="items"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt=""/></div>
                      <div class="items"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt=""/></div>
        ...
        <aside class="col-sm-4 sidebar">
          ...
          <div class="sidebox widget">
            ...
            <ul class="post-list">
              ...
              <li>
                <div class="icon-overlay"> <a href="<?php echo base_url().'Resep/'.$row->tulisan_slug;?>"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt="" /> </a> </div>
                <div class="meta">
                  <h5><a href="<?php echo base_url().'Resep/'.$row->tulisan_slug;?>"><?php echo $row->tulisan_judul;?></a></h5>
