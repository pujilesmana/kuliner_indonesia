...
<link href="<?php echo base_url()?>assets/style/css/color/blue.css" rel="stylesheet">
  ...
  <nav class="navbar">
    <div class="navbar-header">
      <div class="basic-wrapper"> 
        <div class="navbar-brand"> <a href="index.html"><img src="#" srcset="<?php echo base_url()?>assets/style/images/logo.png 1x, <?php echo base_url()?>assets/style/images/logo@2x.png 2x" class="logo-light" alt="" /><img src="#" srcset="<?php echo base_url()?>assets/style/images/logo-dark.png 1x, style/images/logo-dark@2x.png 2x" class="logo-dark" alt="" /></a> </div>
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo base_url()?>Resep" class="" >Resep-Resep</a></li>
        <li><a href="<?php echo base_url()?>Kontak" class="" >Kontak </span></a></li>	
      </ul>
      <!-- /.navbar-nav --> 
    </div>
    <!-- /.navbar-collapse -->
